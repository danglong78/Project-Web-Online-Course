...
//   // let students = require("./seeder/data/4_students/students");
//   // console.log(JSON.stringify(students, null, 4));

//   // console.log(
//   //   "\t\t======================= Main categories ======================="
//   // );
//   // let mainCats = require("./seeder/data/5_mainCats/mainCats");
//   // console.log(mainCats);

//   // console.log(
//   //   "\t\t======================= Sub categories ======================="
//   // );
//   // let subCats = require("./seeder/data/6_subCats/subCats");
//   // console.log(subCats);
